...
O problema consiste em sem saber se as condições climáticas estão propícias para jogar Tênis, será um problema de classificação com base no histórico de dias no qual deram ou não para jogar tênis. A seguir temos a tabela:
